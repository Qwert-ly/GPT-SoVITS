import argparse, copy, json, os, uuid, soundfile, librosa
import gradio as gr
import numpy as np
...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            ...
            splitpoint_slider = gr.Slider(minimum=0, maximum=120.0, value=0, step=0.1, label="Audio Split Point(s)", scale=3)
